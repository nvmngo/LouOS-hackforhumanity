...
if(mode==='online')return <main className="mvp-main"><OnlineReportForm/></main>;
return <main className="mvp-main"><section className="survey-box"><h1>Intake option unavailable</h1><p className="survey-note">Please choose one of the current intake options.</p><Link className="mvp-btn" to="/survey">Return to intake options</Link></section></main>}