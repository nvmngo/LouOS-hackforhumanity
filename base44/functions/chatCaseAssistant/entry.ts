...
export default async function(req: Request): Promise<Response> {
  try {
    ...
    const requestOptions = {method:'POST',headers:{'Content-Type':'application/json','x-goog-api-key':secrets.get('GEMINI_API_KEY')},body:JSON.stringify({contents:[{parts:[{text:prompt}]}],generationConfig:{responseMimeType:'application/json',responseSchema:selectedSchema,temperature:0.1,maxOutputTokens:5000}})};
